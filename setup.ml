...
(* OASIS_START *)
(* DO NOT EDIT (digest: c1e4c982569089486f4ee22a15f13657) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Ring"; "Journal"; "Log"; "S"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "shared-block-ring";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "shared_block_ring_unix";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Block_ring_unix"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "shared_block";
                      lib_findlib_name = Some "unix";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                     cs_name = "shared-block-ring";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("mirage-block-unix", None);
                           InternalLibrary "shared_block";
                           InternalLibrary "shared_block_ring_unix";
                           FindlibPackage ("cstruct", None);
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "MY\158!\215/4E\204\170\150\182!\014\137\020";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
